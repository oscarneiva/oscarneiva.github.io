...
%----------------------------------------------------------------------------------------
\moveleft\hoffset\vbox{\hrule width\resumewidth height 1px}\smallskip %

\vspace{-0.2cm}
\hspace{-3.3cm}
\includegraphics[width=3.0cm]{figures/profile.jpg}
...
\moveleft\hoffset\vbox{\hrule width\resumewidth height 1px}\smallskip % Horizontal line after name; adjust line thickness by changing the '1pt'
